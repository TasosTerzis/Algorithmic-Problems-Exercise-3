...
int main(int argc, char** argv){
    ...
    while (running_flag){
        ...
        for (int i = 0; i < query_set->getNumImages(); i++) {
            ...
            // call rangeSearch
            std::vector<Image *> range_neighbours = rangeSearch(*input_cube, *query_image, R);
            ...
            // print the time needed for the search
            output << "tCube: " << kNN_seconds << " s" << std::endl;
            output << "tTrue: " << bf_seconds << " s" << std::endl;
